...
function init_parsley() {
    if ("undefined" != typeof parsley) {
        ...
        $("parsley:field:validate", function() {
            e()
        }), $("#user_update_form .btn").on("click", function() {
            $("#user_update_form").parsley().validate(), e()
        });
        e = function() {
            !0 === $("#user_update_form").parsley().isValid() ? ($(".bs-callout-info").removeClass("hidden"), $(".bs-callout-warning").addClass("hidden")) : ($(".bs-callout-info").addClass("hidden"), $(".bs-callout-warning").removeClass("hidden"))
        };
        try {
            hljs.initHighlightingOnLoad()
        } catch (e) {}
...
function init_parsley() {
    if ("undefined" != typeof parsley) {
        ...
        $("parsley:field:validate", function() {
            e()
        }), $("#staff_update_form .btn").on("click", function() {
            $("#staff_update_form").parsley().validate(), e()
        });
        e = function() {
            !0 === $("#staff_update_form").parsley().isValid() ? ($(".bs-callout-info").removeClass("hidden"), $(".bs-callout-warning").addClass("hidden")) : ($(".bs-callout-info").addClass("hidden"), $(".bs-callout-warning").removeClass("hidden"))
        };
        try {
            hljs.initHighlightingOnLoad()
        } catch (e) {}
...
function init_parsley() {
    if ("undefined" != typeof parsley) {
        ...
        $("parsley:field:validate", function() {
            e()
        }), $("#staff_add_form .btn").on("click", function() {
            $("#staff_add_form").parsley().validate(), e()
        });
        e = function() {
            !0 === $("#staff_add_form").parsley().isValid() ? ($(".bs-callout-info").removeClass("hidden"), $(".bs-callout-warning").addClass("hidden")) : ($(".bs-callout-info").addClass("hidden"), $(".bs-callout-warning").removeClass("hidden"))
        };
        try {
            hljs.initHighlightingOnLoad()
        } catch (e) {}
...
function init_parsley() {
    if ("undefined" != typeof parsley) {
        ...
        $("parsley:field:validate", function() {
            e()
        }), $("#job_update_form .btn").on("click", function() {
            $("#job_update_form").parsley().validate(), e()
        });
        e = function() {
            !0 === $("#job_update_form").parsley().isValid() ? ($(".bs-callout-info").removeClass("hidden"), $(".bs-callout-warning").addClass("hidden")) : ($(".bs-callout-info").addClass("hidden"), $(".bs-callout-warning").removeClass("hidden"))
        };
        try {
            hljs.initHighlightingOnLoad()
        } catch (e) {}
...
function init_parsley() {
    if ("undefined" != typeof parsley) {
        ...
        $("parsley:field:validate", function() {
            e()
        }), $("#skill_update_form .btn").on("click", function() {
            $("#skill_update_form").parsley().validate(), e()
        });
        e = function() {
            !0 === $("#skill_update_form").parsley().isValid() ? ($(".bs-callout-info").removeClass("hidden"), $(".bs-callout-warning").addClass("hidden")) : ($(".bs-callout-info").addClass("hidden"), $(".bs-callout-warning").removeClass("hidden"))
        };
        try {
            hljs.initHighlightingOnLoad()
        } catch (e) {}
