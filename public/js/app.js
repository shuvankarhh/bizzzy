...
var select = new TomSelect('#proficiency', {
  valueField: 'id',
  searchField: 'title',
  ...
  options: [{
    ...
    desc: 'I write and speak clearly in this language'
  }, {
    id: 3,
    title: 'Fluent',
    ...
    desc: 'I write and speak this language perfectly'
  }],
  render: {
    option: function option(data, escape) {
      return '<div>' + '<span class="title">' + escape(data.title) + '</span>' + '<span class="desc">' + escape(data.desc) + '</span>' + '</div>';
    },
...
add_education = function add_education() {
  ...
  axios.post(APP_URL + '/user/create/add-education', formData).then(function (response) {
    ...
    var html = "<div class=\"col-md-6 mb-2\">\n                        <div class=\"added-exp\">\n                            <p class=\"m-0 font-weight-bold\">".concat(response.data.institute_name, "</p>\n                            <p class=\"m-0\">").concat(response.data.degree, "</p>\n                        </div>\n                    </div>");
    document.getElementById('added_exp').innerHTML += html;
  })["catch"](function (error) {
    console.log(error); // showValidation(error.response.data);
  });
}; // }
