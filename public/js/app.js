...
languages = "<option value=\"af\">Afrikaans</option> <option value=\"sq\">Albanian - shqip</option> <option value=\"am\">Amharic - \u12A0\u121B\u122D\u129B</option> <option value=\"ar\">Arabic - \u0627\u0644\u0639\u0631\u0628\u064A\u0629</option> <option value=\"an\">Aragonese - aragon\xE9s</option> <option value=\"hy\">Armenian - \u0570\u0561\u0575\u0565\u0580\u0565\u0576</option> <option value=\"ast\">Asturian - asturianu</option> <option value=\"az\">Azerbaijani - az\u0259rbaycan dili</option> <option value=\"eu\">Basque - euskara</option> <option value=\"be\">Belarusian - \u0431\u0435\u043B\u0430\u0440\u0443\u0441\u043A\u0430\u044F</option> <option value=\"bn\">Bengali - \u09AC\u09BE\u0982\u09B2\u09BE</option> <option value=\"bs\">Bosnian - bosanski</option> <option value=\"br\">Breton - brezhoneg</option> <option value=\"bg\">Bulgarian - \u0431\u044A\u043B\u0433\u0430\u0440\u0441\u043A\u0438</option> <option value=\"ca\">Catalan - catal\xE0</option> <option value=\"ckb\">Central Kurdish - \u06A9\u0648\u0631\u062F\u06CC (\u062F\u06D5\u0633\u062A\u0646\u0648\u0633\u06CC \u0639\u06D5\u0631\u06D5\u0628\u06CC)</option> <option value=\"zh\">Chinese - \u4E2D\u6587</option> <option value=\"co\">Corsican</option> <option value=\"hr\">Croatian - hrvatski</option> <option value=\"cs\">Czech - \u010De\u0161tina</option> <option value=\"da\">Danish - dansk</option> <option value=\"nl\">Dutch - Nederlands</option> <option value=\"en\">English</option> <option value=\"eo\">Esperanto - esperanto</option> <option value=\"et\">Estonian - eesti</option> <option value=\"fo\">Faroese - f\xF8royskt</option> <option value=\"fil\">Filipino</option> <option value=\"fi\">Finnish - suomi</option> <option value=\"fr\">French - fran\xE7ais</option> <option value=\"gl\">Galician - galego</option> <option value=\"ka\">Georgian - \u10E5\u10D0\u10E0\u10D7\u10E3\u10DA\u10D8</option> <option value=\"de\">German - Deutsch</option> <option value=\"el\">Greek - \u0395\u03BB\u03BB\u03B7\u03BD\u03B9\u03BA\u03AC</option> <option value=\"gn\">Guarani</option> <option value=\"gu\">Gujarati - \u0A97\u0AC1\u0A9C\u0AB0\u0ABE\u0AA4\u0AC0</option> <option value=\"ha\">Hausa</option> <option value=\"haw\">Hawaiian - \u02BB\u014Clelo Hawai\u02BBi</option> <option value=\"he\">Hebrew - \u05E2\u05D1\u05E8\u05D9\u05EA</option> <option value=\"hi\">Hindi - \u0939\u093F\u0928\u094D\u0926\u0940</option> <option value=\"hu\">Hungarian - magyar</option> <option value=\"is\">Icelandic - \xEDslenska</option> <option value=\"id\">Indonesian - Indonesia</option> <option value=\"ia\">Interlingua</option> <option value=\"ga\">Irish - Gaeilge</option> <option value=\"it\">Italian - italiano</option> <option value=\"ja\">Japanese - \u65E5\u672C\u8A9E</option> <option value=\"kn\">Kannada - \u0C95\u0CA8\u0CCD\u0CA8\u0CA1</option> <option value=\"kk\">Kazakh - \u049B\u0430\u0437\u0430\u049B \u0442\u0456\u043B\u0456</option> <option value=\"km\">Khmer - \u1781\u17D2\u1798\u17C2\u179A</option> <option value=\"ko\">Korean - \uD55C\uAD6D\uC5B4</option> <option value=\"ku\">Kurdish - Kurd\xEE</option> <option value=\"ky\">Kyrgyz - \u043A\u044B\u0440\u0433\u044B\u0437\u0447\u0430</option> <option value=\"lo\">Lao - \u0EA5\u0EB2\u0EA7</option> <option value=\"la\">Latin</option> <option value=\"lv\">Latvian - latvie\u0161u</option> <option value=\"ln\">Lingala - ling\xE1la</option> <option value=\"lt\">Lithuanian - lietuvi\u0173</option> <option value=\"mk\">Macedonian - \u043C\u0430\u043A\u0435\u0434\u043E\u043D\u0441\u043A\u0438</option> <option value=\"ms\">Malay - Bahasa Melayu</option> <option value=\"ml\">Malayalam - \u0D2E\u0D32\u0D2F\u0D3E\u0D33\u0D02</option> <option value=\"mt\">Maltese - Malti</option> <option value=\"mr\">Marathi - \u092E\u0930\u093E\u0920\u0940</option> <option value=\"mn\">Mongolian - \u043C\u043E\u043D\u0433\u043E\u043B</option> <option value=\"ne\">Nepali - \u0928\u0947\u092A\u093E\u0932\u0940</option> <option value=\"no\">Norwegian - norsk</option> <option value=\"nb\">Norwegian Bokm\xE5l - norsk bokm\xE5l</option> <option value=\"nn\">Norwegian Nynorsk - nynorsk</option> <option value=\"oc\">Occitan</option> <option value=\"or\">Oriya - \u0B13\u0B21\u0B3C\u0B3F\u0B06</option> <option value=\"om\">Oromo - Oromoo</option> <option value=\"ps\">Pashto - \u067E\u069A\u062A\u0648</option> <option value=\"fa\">Persian - \u0641\u0627\u0631\u0633\u06CC</option> <option value=\"pl\">Polish - polski</option> <option value=\"pt\">Portuguese - portugu\xEAs</option> <option value=\"pt-BR\">Portuguese (Brazil) - portugu\xEAs (Brasil)</option> <option value=\"pt-PT\">Portuguese (Portugal) - portugu\xEAs (Portugal)</option> <option value=\"pa\">Punjabi - \u0A2A\u0A70\u0A1C\u0A3E\u0A2C\u0A40</option> <option value=\"qu\">Quechua</option> <option value=\"ro\">Romanian - rom\xE2n\u0103</option> <option value=\"mo\">Romanian (Moldova) - rom\xE2n\u0103 (Moldova)</option> <option value=\"rm\">Romansh - rumantsch</option> <option value=\"ru\">Russian - \u0440\u0443\u0441\u0441\u043A\u0438\u0439</option> <option value=\"gd\">Scottish Gaelic</option> <option value=\"sr\">Serbian - \u0441\u0440\u043F\u0441\u043A\u0438</option> <option value=\"sh\">Serbo-Croatian - Srpskohrvatski</option> <option value=\"sn\">Shona - chiShona</option> <option value=\"sd\">Sindhi</option> <option value=\"si\">Sinhala - \u0DC3\u0DD2\u0D82\u0DC4\u0DBD</option> <option value=\"sk\">Slovak - sloven\u010Dina</option> <option value=\"sl\">Slovenian - sloven\u0161\u010Dina</option> <option value=\"so\">Somali - Soomaali</option> <option value=\"st\">Southern Sotho</option> <option value=\"es\">Spanish - espa\xF1ol</option> <option value=\"su\">Sundanese</option> <option value=\"sw\">Swahili - Kiswahili</option> <option value=\"sv\">Swedish - svenska</option> <option value=\"tg\">Tajik - \u0442\u043E\u04B7\u0438\u043A\u04E3</option> <option value=\"ta\">Tamil - \u0BA4\u0BAE\u0BBF\u0BB4\u0BCD</option> <option value=\"tt\">Tatar</option> <option value=\"te\">Telugu - \u0C24\u0C46\u0C32\u0C41\u0C17\u0C41</option> <option value=\"th\">Thai - \u0E44\u0E17\u0E22</option> <option value=\"ti\">Tigrinya - \u1275\u130D\u122D\u129B</option> <option value=\"to\">Tongan - lea fakatonga</option> <option value=\"tr\">Turkish - T\xFCrk\xE7e</option> <option value=\"tk\">Turkmen</option> <option value=\"tw\">Twi</option> <option value=\"uk\">Ukrainian - \u0443\u043A\u0440\u0430\u0457\u043D\u0441\u044C\u043A\u0430</option> <option value=\"ur\">Urdu - \u0627\u0631\u062F\u0648</option> <option value=\"ug\">Uyghur</option> <option value=\"uz\">Uzbek - o\u2018zbek</option> <option value=\"vi\">Vietnamese - Ti\u1EBFng Vi\u1EC7t</option> <option value=\"wa\">Walloon - wa</option> <option value=\"cy\">Welsh - Cymraeg</option> <option value=\"fy\">Western Frisian</option> <option value=\"xh\">Xhosa</option> <option value=\"yi\">Yiddish</option> <option value=\"yo\">Yoruba - \xC8d\xE8 Yor\xF9b\xE1</option> <option value=\"zu\">Zulu - isiZulu</option>";
...
questionSelect = function questionSelect(val, link) {
  location.href = link;
};

first_working_experience = function first_working_experience(link) {
  location.href = link;
}; // Helper Functions
...
var modal_form_close = function modal_form_close(id, modal) {
  document.getElementById("".concat(modal, "_close_button")).click();
...
add_work_experience = function add_work_experience() {
  ...
  axios.post(APP_URL + "/user/create/add-work-experience", formData).then(function (response) {
    location.href = ""; // modal_form_close("work_experience_form", "work_modal");
    // let company =
...
resend_email_verification = function resend_email_verification(ele, email) {
...
saveJob = function saveJob(e) {
  axios.post(APP_URL + "/f/save-job/store", {
...
removeSavedJobs = function removeSavedJobs(e) {
  axios.post(APP_URL + "/f/save-job/".concat(e.target.dataset.job), {
    _method: 'DELETE'
  }).then(function (response) {
    console.log(response.data);
    location.reload();
...
loadsingleuser = function loadsingleuser(id) {
  axios.get(APP_URL + "/admin/user/".concat(id, "/edit")).then(function (response) {
    //console.log(response);
    ...
    $('.photo').attr("src", "".concat(APP_URL, "/storage/").concat(path_img));
  })["catch"](function (error) {});
}; //update user
...
if (user_update_form) {
  user_update_form.addEventListener('submit', function (e) {
    e.preventDefault();
    var formData = new FormData(user_update_form);
    var id = document.getElementById('user_id');
    axios.post(APP_URL + "/admin/user/".concat(id.value), formData).then(function (response) {
      // console.log(response);
      location.reload();
    })["catch"](function (error) {
      if (typeof error.response !== "undefined") {
...
loadsinglestaff = function loadsinglestaff(id) {
  axios.get(APP_URL + "/admin/staff/".concat(id, "/edit")).then(function (response) {
    //console.log(response);
    document.getElementById('name').value = response.data.name;
    document.getElementById('user_name').value = response.data.user_name;
    document.getElementById('acting_status').value = response.data.acting_status;
...
var staff_update_form = document.getElementById('staff_update_form');

if (staff_update_form) {
  staff_update_form.addEventListener('submit', function (e) {
    e.preventDefault();
    var formData = new FormData(staff_update_form);
    var id = document.getElementById('user_id');
    axios.post(APP_URL + "/admin/staff/".concat(id.value), formData).then(function (response) {
      // console.log(response);
      location.reload();
    })["catch"](function (error) {
      if (typeof error.response !== "undefined") {
...
var staff_add_form = document.getElementById('staff_add_form');
...
loadsinglejob = function loadsinglejob(id) {
  axios.get(APP_URL + "/admin/job/".concat(id, "/edit")).then(function (response) {
    console.log(response);
    document.getElementById('job_id').value = response.data.id;
    document.getElementById('name').value = response.data.name;
    document.getElementById('description').value = response.data.description; //job job_visibility
...
var job_update_form = document.getElementById('job_update_form');

if (job_update_form) {
  job_update_form.addEventListener('submit', function (e) {
    e.preventDefault();
    var formData = new FormData(job_update_form);
    var id = document.getElementById('job_id');
    axios.post(APP_URL + "/admin/job/".concat(id.value), formData).then(function (response) {
      //console.log(response);
      location.reload();
    })["catch"](function (error) {
      if (typeof error.response !== "undefined") {
...
loadsingleskill = function loadsingleskill(id) {
  axios.get(APP_URL + "/admin/skill/".concat(id, "/edit")).then(function (response) {
    //console.log(response);
    document.getElementById('name').value = response.data.name;
    document.getElementById('acting_status').value = response.data.acting_status;
...
var skill_update_form = document.getElementById('skill_update_form');

if (skill_update_form) {
  skill_update_form.addEventListener('submit', function (e) {
    e.preventDefault();
    var formData = new FormData(skill_update_form);
    var id = document.getElementById('skill_id');
    axios.post(APP_URL + "/admin/skill/".concat(id.value), formData).then(function (response) {
      //console.log(response);
      location.reload();
    })["catch"](function (error) {
      if (typeof error.response !== "undefined") {
...
change_type = function change_type(type) {
  axios.post(APP_URL + "/change-account/".concat(type)).then(function (response) {
...
function change_level(event) {
  var loaderList = document.getElementById('loader').classList;
  var successList = document.getElementById('success').classList;
  loaderList.remove('loader-hidden');
  axios.post(APP_URL + '/experience', {
...
document.querySelectorAll("input[name='experience_level']").forEach(function (input) {
  input.addEventListener('change', change_level);
}); // Recruiter End Contract

var endContract = document.getElementById('recruiter_end_contract_form');

if (endContract) {
  endContract.addEventListener('submit', function (e) {
    e.preventDefault();
    var formData = new FormData(endContract);
    axios.post(APP_URL + "/r/end-contract", formData).then(function (response) {
      location.href = response.data;
    })["catch"](function (error) {
...
var freelancerEndContract = document.getElementById('freelancer_end_contract_form');

if (freelancerEndContract) {
  freelancerEndContract.addEventListener('submit', function (e) {
    e.preventDefault();
    var formData = new FormData(freelancerEndContract);
    axios.post(APP_URL + "/f/end-contract", formData).then(function (response) {
      location.href = response.data;
    })["catch"](function (error) {
      document.getElementById('error').classList.remove('d-none');
    });
...
var bonus_payment = function bonus_payment(e) {
  if (e.target.checked) {
...
release_fund_handeler = function release_fund_handeler(e) {
...
activate_next_milestone_handeler = function activate_next_milestone_handeler(e) {
  axios.get(APP_URL + "/r/activate-next-milestone/create", {
    params: {
...
activate_milestone_form_handler = function activate_milestone_form_handler(e) {
  e.preventDefault();
  var activate_milestone_btn = document.getElementById('activate_milestone_btn');
  var innerHTML = activate_milestone_btn.innerHTML;
  activate_milestone_btn.disabled = true;
  activate_milestone_btn.innerHTML = fa_spinning;
  var formData = new FormData(e.target);
  axios.post(APP_URL + "/r/activate-next-milestone/".concat(document.getElementById('activate_contract').value), formData).then(function (response) {
    console.log(response);
    location.reload();
  })["catch"](function (error) {
    activate_milestone_btn.disabled = false;
    activate_milestone_btn.innerHTML = innerHTML;
    var stripe_payment_error = document.getElementById('stripe_payment_error');
...
editMilestoneHandler = function editMilestoneHandler(e) {
...
edit_milestone_form_handler = function edit_milestone_form_handler(e) {
  e.preventDefault();
  var formData = new FormData(e.target);
  formData.append('_method', 'patch');
  axios.post(APP_URL + "/r/single-milestone/".concat(document.getElementById('edit_milestone').value), formData).then(function (response) {
    location.reload();
  })["catch"](function (error) {
    if (typeof error.response !== "undefined") {
      //  This is for error from laravel
...
proceed_to_payment = function proceed_to_payment() {
  ...
  var bonus_pay = document.getElementById('bonus_pay');
  var bonus = document.getElementById('bonus');
  bonus.classList.remove('is-invalid');
  var contract_status = document.querySelector('input[name=contract_status]:checked');
  ...
  axios.get(APP_URL + "/payment-methods/create").then(function (response) {
    var payment_div = document.getElementById('release_milestone_payment_div');
    ...
    var input_divs = document.getElementById('inputs_div');
    ...
    document.getElementById('payment_previous_step_button').addEventListener('click', function () {
...
release_payment_form_submit = function release_payment_form_submit(e) {
  var milestone_release_payment = document.getElementById('milestone_release_payment');
...
/***/ "./resources/js/bootstrap_v5-0-2/bootstrap.bundle.js":
/*!***********************************************************!*\
  !*** ./resources/js/bootstrap_v5-0-2/bootstrap.bundle.js ***!
  \***********************************************************/
