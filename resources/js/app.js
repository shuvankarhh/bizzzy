...
add_milestone_form_submit = (e) => {
    e.preventDefault();
    let formData = new FormData(add_new_milestone_form);
    let fund_submit = document.getElementById('fund_submit');
    fund_submit.disabled = true;
    fund_submit.innerHTML = '<i class="fa-solid fa-circle-notch fa-spin"></i>';
    axios
    .post(APP_URL + `/r/contract-milestone/${document.getElementById('add_milestone_to').value}`, formData)
    .then(function(response) {
        location.reload();
    })
    .catch(function(error) {
...
calculate_deposit_amount = (e) => {
    let in_escrow = Number(document.getElementById('in_escrow').value);
...
add_milestone_payment = () => {
    let form_data = new FormData(document.getElementById('add_new_milestone_form'));
    axios
    .post(APP_URL + `/r/new-milestone/create/${document.getElementById('add_milestone_to').value}`,form_data)
    .then(function(response) {
