...
<div class="container">
    ...
    <form action="#" id="recruiter_end_contract_form">
        ...
        <div class="card mt-5">
            ...
            <div class="card-body">
                <p class="m-0 p-0">Feedback to freelancer</p>
                ...
                <div class="rating-wrapper">
                    <div class="rating">
                        <label>
                            <input class="feedback-input"  type="radio" name="quality_of_work" value="1" />
                            <span class="icon">★</span>
                        </label>
                        <label>
                            <input class="feedback-input"  type="radio" name="quality_of_work" value="2" />
                            <span class="icon">★</span>
                            <span class="icon">★</span>
                        </label>
                        <label>
                            <input class="feedback-input"  type="radio" name="quality_of_work" value="3" />
                            <span class="icon">★</span>
                            <span class="icon">★</span>
                            <span class="icon">★</span>
                        </label>
                        <label>
                            <input class="feedback-input"  type="radio" name="quality_of_work" value="4" />
                            <span class="icon">★</span>
                            <span class="icon">★</span>
                            <span class="icon">★</span>
                            <span class="icon">★</span>
                        ...
                        <label>
                            <input class="feedback-input"  type="radio" name="quality_of_work" value="5" />
                            <span class="icon">★</span>
                            <span class="icon">★</span>
                            <span class="icon">★</span>
                            <span class="icon">★</span>
                ...
                <div class="rating-wrapper">
                    <div class="rating">
                        <label>
                            <input class="feedback-input"  type="radio" name="adherence_to_schedule" value="1" />
                            <span class="icon">★</span>
                        </label>
                        <label>
                            <input class="feedback-input"  type="radio" name="adherence_to_schedule" value="2" />
                            <span class="icon">★</span>
                            <span class="icon">★</span>
                        </label>
                        <label>
                            <input class="feedback-input"  type="radio" name="adherence_to_schedule" value="3" />
                            <span class="icon">★</span>
                            <span class="icon">★</span>
                            <span class="icon">★</span>
                        </label>
                        <label>
                            <input class="feedback-input"  type="radio" name="adherence_to_schedule" value="4" />
                            <span class="icon">★</span>
                            <span class="icon">★</span>
                            <span class="icon">★</span>
                            <span class="icon">★</span>
                        ...
                        <label>
                            <input class="feedback-input"  type="radio" name="adherence_to_schedule" value="5" />
                            <span class="icon">★</span>
                            <span class="icon">★</span>
                            <span class="icon">★</span>
                            <span class="icon">★</span>
    ...
    {{-- <div class="card mt-5">
        ...
        <div class="card-body">
            ...
            <div class="rating-wrapper">
                <div class="rating">
                    <label>
                        <input type="radio" name="quality_of_requirment" value="1" />
                        <span class="icon">★</span>
                    </label>
                    <label>
                        <input type="radio" name="quality_of_requirment" value="2" />
                        <span class="icon">★</span>
                        <span class="icon">★</span>
                    </label>
                    <label>
                        <input type="radio" name="quality_of_requirment" value="3" />
                        <span class="icon">★</span>
                        <span class="icon">★</span>
                        <span class="icon">★</span>
                    </label>
                    <label>
                        <input type="radio" name="quality_of_requirment" value="4" />
                        <span class="icon">★</span>
                        <span class="icon">★</span>
                        <span class="icon">★</span>
                        <span class="icon">★</span>
                    ...
                    <label>
                        <input type="radio" name="quality_of_requirment" value="5" />
                        <span class="icon">★</span>
                        <span class="icon">★</span>
                        <span class="icon">★</span>
                        <span class="icon">★</span>
            ...
            <div class="rating-wrapper">
                <div class="rating">
                    ...
                    <label>
                        <input type="radio" name="availability" value="4" />
                        <span class="icon">★</span>
                        <span class="icon">★</span>
                        <span class="icon">★</span>
                        <span class="icon">★</span>
                    ...
                    <label>
                        <input type="radio" name="availability" value="5" />
                        <span class="icon">★</span>
                        <span class="icon">★</span>
                        <span class="icon">★</span>
                        <span class="icon">★</span>
            ...
            <div class="rating-wrapper">
                <div class="rating">
                    <label>
                        <input type="radio" name="adherence_to_schedule" value="1" />
                        <span class="icon">★</span>
                    </label>
                    <label>
                        <input type="radio" name="deadline_set" value="2" />
                        <span class="icon">★</span>
                        <span class="icon">★</span>
                    </label>
                    <label>
                        <input type="radio" name="deadline_set" value="3" />
                        <span class="icon">★</span>
                        <span class="icon">★</span>
                        <span class="icon">★</span>
                    </label>
                    <label>
                        <input type="radio" name="deadline_set" value="4" />
                        <span class="icon">★</span>
                        <span class="icon">★</span>
                        <span class="icon">★</span>
                        <span class="icon">★</span>
                    ...
                    <label>
                        <input type="radio" name="deadline_set" value="5" />
                        <span class="icon">★</span>
                        <span class="icon">★</span>
                        <span class="icon">★</span>
                        <span class="icon">★</span>
            ...
            <div class="rating-wrapper">
                <div class="rating">
                    <label>
                        <input type="radio" name="cooperation" value="1" />
                        <span class="icon">★</span>
                    </label>
                    <label>
                        <input type="radio" name="cooperation" value="2" />
                        <span class="icon">★</span>
                        <span class="icon">★</span>
                    </label>
                    <label>
                        <input type="radio" name="cooperation" value="3" />
                        <span class="icon">★</span>
                        <span class="icon">★</span>
                        <span class="icon">★</span>
                    </label>
                    <label>
                        <input type="radio" name="cooperation" value="4" />
                        <span class="icon">★</span>
                        <span class="icon">★</span>
                        <span class="icon">★</span>
                        <span class="icon">★</span>
                    ...
                    <label>
                        <input type="radio" name="cooperation" value="5" />
                        <span class="icon">★</span>
                        <span class="icon">★</span>
                        <span class="icon">★</span>
                        <span class="icon">★</span>
...
@push('script')
    <script>
        let feedback_calculator = (e) => {
            ...
            let quality_of_work =  document.querySelector('input[name="quality_of_work"]:checked');
            quality_of_work = (quality_of_work === null) ? 0 : (Number(quality_of_work.value) / 5);
            ...
            let adherence_to_schedule =  document.querySelector('input[name="adherence_to_schedule"]:checked');
            adherence_to_schedule = (adherence_to_schedule === null) ? 0 : ((Number(adherence_to_schedule.value) * 0.75) / 5);
            ...
            let total = skill + quality_of_work + availability + adherence_to_schedule + communication + cooperation
