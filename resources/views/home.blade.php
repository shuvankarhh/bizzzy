    ...
    <section class="container top_hero_section">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 ">
                ...
                <div>
                    <img class="top_hero_main_img zigzag" style=" height: 30px;width: 90px;position: absolute;top: 25vh;right: 45vw; z-index: -1" src="{{ asset('/images/extra_fillers/zigzag-green.png') }}" alt="">
                </div>
                <div>
                ...
                <div>
                    <img class="sub_img triangle" src="{{asset('/images/extra_fillers/triangles-green.png')}}" style="position: absolute;left: 45vw;top: 600px; z-index: -1;" alt="">
                </div>
                <div>
