            ...
            <div class="col-md-5 col-lg-5 col-xl-5 d-none d-sm-none d-md-block align-items-end">
                <div class="card bizzy-tip-bio" style=""><img src="{{asset('/images/card/card1.png')}}"
                    ...
                    <div class="card-body text-start" style="margin-top: 0px">
                        ...
                        <p class="card-text sm text-start" style="">“I’m a developer with experience in building websites for small and medium sized businesses. Whether you’re trying to win work, list your services or even create a whole online store – I can help!
                            <ul>
    ...
    <div class="question-footer">
        ...
        <div class="row justify-content-end">
            <div class="col-md-3 text-end">
                <button onclick="add_language('{{ route('question.eleven') }}')" class="btn btn-bizzzy-success text-nowrap me-3"> Choose Your Area of Work </button>
            </div>
        </div>
    </div>
</section>
