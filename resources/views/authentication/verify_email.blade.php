        ...
        <div class="col-12 col-md-8 col-lg-6 col-xl-5 col-sm-3">
            <div class="card shadow-2-strong" style="border-radius: 1rem;">
                <div class="card-body text-center">
                    ...
                    <a style="font-style: normal; color: #0086FF;margin-top: 20px; margin-bottom: 20px;
                    font-weight: 500;
                    font-size: 14px;
                    line-height: 20px;"> Change email</a><br>
                    <a style="font-style: normal; color: #0086FF;margin-top: 20px; margin-bottom: 50px;
                    font-weight: 500;
                    font-size: 14px;
                    line-height: 20px;">I need help verifying my email</a>

                    <button onclick="resend_email_verification(this, '{{ $email }}')" class="btn btn-primary btn-lg btn-block" style="background-color: #0086FF; margin-top: 50px;" type="submit">Resend Verification Email</button>
