                         ...
                         <ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
                             <li class="nav-item">
                                 <div class="search_input_group">
                                     <img src="{{ asset('/images/icons/search-gray.svg') }}"
                                         class="search_icon_input">
                         ...
                         <ul class="navbar-nav ms-auto">
                             ...
                             @if ($recruiter)
                                 <li class="nav-item dropdown">
                                     <a class="nav-link text-reset me-2 dropdown-toggle hidden-arrow" href="#"
                                         id="jobsDropdown" role="button" data-mdb-toggle="dropdown"
                                         aria-expanded="false"> Jobs </a>
                                     <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="jobsDropdown">
                                         <li>
                                             <a class="dropdown-item" href="{{ route('recruiter.job.index') }}">My
                                                 Jobs</a>
                                         </li>
                                         <li>
                                             <a class="dropdown-item" href="{{ route('job.index') }}">All Job
                                                 Posts</a>
                                         </li>
                                         <li>
                                             <a class="dropdown-item"
                                                 href="{{ route('recruiter.contract.index') }}">All Contracts</a>
                                         </li>
                                         <li>
                                             <a class="dropdown-item" href="{{ route('job.create') }}">Post a
                                                 Job</a>
                                         </li>
                                         <li>
                                             <a href="{{ route('freelancer.index') }}" class="dropdown-item"
                                                 aria-current="page" href="#">Any Hire</a>
                                         </li>
                                     </ul>
                                 </li>
                                 <li class="nav-item dropdown">
                                     <a class="nav-link text-reset me-2 dropdown-toggle hidden-arrow" href="#"
                                         id="talentsDropdown" role="button" data-mdb-toggle="dropdown"
                                         aria-expanded="false"> Talent </a>
                                 ...
                                 <li class="nav-item dropdown">
                                     <a class="nav-link text-reset me-2 dropdown-toggle hidden-arrow" href="#"
                                         id="reportsDropdown" role="button" data-mdb-toggle="dropdown"
                                 ...
                                 <li class="nav-item">
                                     <a href="#" class="nav-link text-reset me-3" aria-current="page"
                                         href="#">Messages</a>
                                 </li>
                             @else
                                 <li class="nav-item dropdown">
                                     <a class="nav-link text-reset me-2 dropdown-toggle hidden-arrow" href="#"
                                         id="findWorkDropdown" role="button" data-mdb-toggle="dropdown"
                                         aria-expanded="false"> Jobs </a>
                                     <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="findWorkDropdown">
                                         <li>
                                             <a class="dropdown-item" href="{{ route('job.index') }}">Find
                                                 Work</a>
                                         </li>
                                         <li>
                                         ...
                                         <li>
                                             <a class="dropdown-item"
                                                 href="{{ route('job.offer.index') }}">Proposals</a>
                                         </li>
                                         <li>
                                             <a class="dropdown-item"
                                                 href="{{ route('freelancer.profile.index') }}">Profile</a>
                                         </li>
                                         <li>
                                 ...
                                 <li class="nav-item dropdown">
                                     <a class="nav-link text-reset me-2 dropdown-toggle hidden-arrow" href="#"
                                         id="myJobsDropdown" role="button" data-mdb-toggle="dropdown"
                                         aria-expanded="false"> My Jobs </a>
                                     <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="myJobsDropdown">
                                         ...
                                         <li>
                                             <a class="dropdown-item"
                                                 href="{{ route('freelancer.contract.index') }}">All Contracts</a>
                                         </li>
                                         <li>
                                 ...
                                 <li class="nav-item dropdown">
                                     <a class="nav-link text-reset me-2 dropdown-toggle hidden-arrow" href="#"
                                         id="freelancerReportsDropdown" role="button" data-mdb-toggle="dropdown"
                                         aria-expanded="false"> Reports </a>
                                     <ul class="dropdown-menu dropdown-menu-end"
                                         aria-labelledby="freelancerReportsDropdown">
                                         <li>
                                     ...
                                     <ul class="navbar-nav ms-auto">
                                         ...
                                         @if ($recuiter)
                                             <li class="nav-item dropdown">
                                                 <a class="nav-link text-reset me-2 dropdown-toggle hidden-arrow"
                                                     href="#" id="jobsDropdown" role="button" data-mdb-toggle="dropdown"
                                                     aria-expanded="false"> Jobs </a>
                                                 <ul class="dropdown-menu dropdown-menu-end"
                                                     aria-labelledby="jobsDropdown">
                                                     <li>
                                                         <a class="dropdown-item"
                                                             href="{{ route('recruiter.job.index') }}">My
                                                             Jobs</a>
                                                     </li>
                                                     <li>
                                                         <a class="dropdown-item"
                                                             href="{{ route('job.index') }}">All Job
                                                             Posts</a>
                                                     </li>
                                                     <li>
                                                         <a class="dropdown-item"
                                                             href="{{ route('recruiter.contract.index') }}">All
                                                             Contracts</a>
                                                     </li>
                                                     <li>
                                                         <a class="dropdown-item"
                                                             href="{{ route('job.create') }}">Post a Job</a>
                                                     </li>
                                                     <li>
                                                         <a href="{{ route('freelancer.index') }}"
                                                             class="dropdown-item" aria-current="page" href="#">Any
                                                             Hire</a>
                                                     </li>
                                                 </ul>
                                             </li>
                                             <li class="nav-item dropdown">
                                                 <a class="nav-link text-reset me-2 dropdown-toggle hidden-arrow"
                                                     href="#" id="talentsDropdown" role="button"
                                                     data-mdb-toggle="dropdown" aria-expanded="false"> Talent </a>
                                                 <ul class="dropdown-menu dropdown-menu-end"
                                                     aria-labelledby="talentsDropdown">
                                                     <li>
                                                         <a class="dropdown-item" href="#">Discover</a>
                                                     </li>
                                                     <li>
                                             ...
                                             <li class="nav-item dropdown">
                                                 <a class="nav-link text-reset me-2 dropdown-toggle hidden-arrow"
                                                     ...
                                                     data-mdb-toggle="dropdown" aria-expanded="false"> Reports </a>
                                                 <ul class="dropdown-menu dropdown-menu-end"
                                         ...
                                         @else
                                             <li class="nav-item dropdown">
                                                 <a class="nav-link text-reset me-2 dropdown-toggle hidden-arrow"
                                                     href="#" id="findWorkDropdown" role="button"
                                                     data-mdb-toggle="dropdown" aria-expanded="false"> Jobs </a>
                                                 <ul class="dropdown-menu dropdown-menu-end"
                                                     aria-labelledby="findWorkDropdown">
                                                     <li>
                                                         <a class="dropdown-item"
                                                             href="{{ route('job.index') }}">Find Work</a>
                                                     </li>
                                                     <li>
                                                         <a class="dropdown-item" href="#">Saved jobs</a>
                                                     </li>
                                             ...
                                             <li class="nav-item dropdown">
                                                 <a class="nav-link text-reset me-2 dropdown-toggle hidden-arrow"
                                                     href="#" id="myJobsDropdown" role="button"
                                                     data-mdb-toggle="dropdown" aria-expanded="false"> My Jobs </a>
                                                 <ul class="dropdown-menu dropdown-menu-end"
                                                     aria-labelledby="myJobsDropdown">
                                                     <li>
                                                         <a class="dropdown-item" href="#">My Jobs</a>
                                                     </li>
                                                     <li>
                                                         <a class="dropdown-item"
                                                             href="{{ route('freelancer.contract.index') }}">All
                                                             Contracts</a>
                                                     </li>
                                                     <li>
                                                         <a class="dropdown-item" href="#">Work Diary</a>
                                             ...
                                             <li class="nav-item dropdown">
                                                 <a class="nav-link text-reset me-2 dropdown-toggle hidden-arrow"
                                                     href="#" id="freelancerReportsDropdown" role="button"
                                                     data-mdb-toggle="dropdown" aria-expanded="false"> Reports </a>
                                                 <ul class="dropdown-menu dropdown-menu-end"
                                                     aria-labelledby="freelancerReportsDropdown">
                                                     <li>
                                                     ...
                                                     <li>
                                                         <a class="dropdown-item" href="#">Certifacte of
                                                             Earnings</a>
                                                     </li>
                                                 </ul>
                                             </li>
                 ...
                 <div class="ms-auto d-flex align-items-center lg-authentication">
                     ...
                     <div class="dropdown">
                         <a class="dropdown-toggle d-flex align-items-center hidden-arrow" href="#"
                             ...
                             aria-expanded="false">
                             <img src="
                                  @if (file_exists(public_path('storage/' . auth()->user()->photo))) {{ asset('storage/' . auth()->user()->photo) }}
                          @else
                         ...
                         <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownMenuAvatar">
                             @auth('admin')
                                 ...
                                 <li>
                                     ...
                                     <ul class="dropdown-menu dropdown-submenu dropdown-submenu-left">
                                         ...
                                         <li>
                                             <a class="dropdown-item"
                                                 href="{{ route('permission.role.index') }}">Permission to Role</a>
                                         </li>
                                     </ul>
                                 </li>
                             @endauth
                          ...
                          @else
                            {{ asset('images\general\avatar.png') }} @endif
                             ...
                             <li>
                                 <a class="dropdown-item" href="#"><i class="fa-solid fa-gear"></i><span
                                         class="ms-2">Settings</span></a>
                             </li>
                             <li>
                                 <form action="{{ route('user.logout') }}" method="post">
                                     @csrf
                                     <button class="dropdown-item" type="submit"><i class="fas fa-sign-out"></i><span
                             ...
                             <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownMenuAvatar">
                                 @auth('admin')
                                     ...
                                     <li>
                                         ...
                                         <ul class="dropdown-menu dropdown-submenu dropdown-submenu-left">
                                             ...
                                             <li>
                                                 <a class="dropdown-item"
                                                     href="{{ route('permission.role.index') }}">Permission to
                                                     Role</a>
                                             </li>
                                         </ul>
                                     </li>
                                 ...
                                 <li>
                                     <div class="form-check"
                                         style="display: inline-block; white-space: nowrap; text-align: center; padding: 1rem">
                                         <input class="register-radio left" type="radio" id="freelancer"
                                             name="freelancer_or_recuriter" value="freelancer" checked />
                                         <label for="freelancer">Online</label>
                                         <input class="register-radio right" type="radio" id="recruiter"
                                             name="freelancer_or_recuriter" value="recruiter" />
                     ...
                     @guest('admin')
                         <div class="d-flex align-items-center lg-authentication">
                             @guest()
                                 {{-- <li class="nav-item"> --}}
                                 <a class="nav-link login" aria-current="page" href="{{ route('user.login') }}">Sign
                                     In</a>
                                 {{-- </li> --}}
                                 {{-- <li class="nav-item"> --}}
                                 <a class="btn btn-outline-success signup-lg" role="button"
                                     href="{{ route('user.register') }}">Sign Up</a>
                                 {{-- </li> --}}
                             @endguest
                         </div>
                     @endguest
