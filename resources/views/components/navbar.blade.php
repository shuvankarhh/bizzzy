                        ...
                        @if (session('user_type', 'none') == 1)
                            <li class="nav-item">
                                <a href="{{ route('freelancer.index') }}"
                                    class="nav-link {{ request()->is('jobs') ? 'active' : '' }}" aria-current="page"
                                    href="#">Hire</a>
                            </li>
            ...
            <div class="d-flex align-items-center lg-authentication">
                @auth
                    ...
                    <div class="dropdown">
                        <a class="dropdown-toggle d-flex align-items-center hidden-arrow" href="#"
                            ...
                            <img src="{{ asset('images\general\avatar.png') }}" class="rounded-circle" height="25"
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownMenuAvatar">
                            @auth('web')
                                ...
                                <li>
                                    ...
                                    <a class="dropdown-item" href="{{ route('freelancer.contract.index') }}">Active
                                        Contracts</a>
                                </li>
                            @endauth
                            @auth('admin')
                                ...
                                <li>
                                    ...
                                    <ul class="dropdown-menu dropdown-submenu dropdown-submenu-left">
                                        ...
                                        <li>
                                            <a class="dropdown-item" href="{{ route('permission.role.index') }}">Permission
                                                to Role</a>
                                        </li>
                                    </ul>
                                </li>
                ...
                @guest('admin')
                    @guest()
                        ...
                        {{-- </li> --}}
                        {{-- <li class="nav-item"> --}}
                        <a class="btn btn-outline-success signup-lg" role="button" href="{{ route('user.register') }}">Sign
                            Up</a>
                        {{-- </li> --}}
                    @endguest
                @endguest
